...
window.onload=function(){
    ...
    var oSortM=document.getElementsByClassName('sortMenu');
    var aCommodityList=document.getElementsByClassName('commodityMessage');
    var aMenu=['女装','鞋靴','童装玩具','家电','美妆','珠宝','运动','游戏','美食','鲜花','房产','家具','汽车','办公','百货','学习'];
    var oMenu=document.getElementsByClassName('rightMenu')[0];
    var timer=0;
